...
const SubscriptionBox = ({ index, discount, details, imageUrl }) => {
    return (
...
const Subscriptions = () => {
    return (
        <div className="flex flex-col justify-center items-center bg-gray-100" style={{ height: 'calc(100vh - 96px)' }}>
          ...
          imageUrl="https://via.placeholder.com/300x300?text=Subscription+1" />
                <SubscriptionBox index={1} discount="15% OFF" details="Details about the subscription 2" 
          imageUrl="https://via.placeholder.com/300x300?text=Subscription+2" />
                <SubscriptionBox index={2} discount="10% OFF" details="Details about the subscription 3" 
          imageUrl="https://via.placeholder.com/300x300?text=Subscription+3" />
            </div>
        </div>
    );
};
